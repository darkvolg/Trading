    ...
    <div className="min-h-screen bg-background text-foreground">
      <article className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="space-y-6 text-muted leading-relaxed">
          ...
          <p>With a verified documented backtest win rate (current value on /live), solid SQN (see /live), and just low maximum drawdown (see /live) across 10,000+ backtest trades, TrendRider delivers institutional-grade signal quality. Signals include exact entry prices, stop-losses, and take-profit targets &mdash; ready for manual execution or auto-trading through <a href="/blog/cornix-auto-trade-setup-guide" className="text-primary hover:underline">Cornix</a>.</p>
