    ...
    <div className="min-h-screen bg-background text-foreground">
      <article className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className="space-y-6 text-muted leading-relaxed">
          ...
          <p>Consider scaling into positions rather than entering full size at once. Enter 50% at your initial signal, add 25% on a pullback to support, and the final 25% on trend confirmation. This averaging-in approach reduces your exposure to poor entry timing and lowers your average cost basis on winning trades.</p>
