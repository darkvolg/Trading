export const T = {
  en: {
    ...
    feat1Title: "AI Confidence Scoring",
    feat1Desc: "AI-powered confidence scoring from 1-10 analyzing 12+ market indicators including on-chain data, sentiment, and technical factors.",
    ...
    compCol3: "TrendRider",
    compRow1: ["Emotion Control", "Hard — fear & greed", "Eliminated — AI-powered algorithm"],
  ...
  ru: {
    ...
    feat1Title: "AI-оценка уверенности",
    feat1Desc: "AI-оценка уверенности от 1 до 10 на основе 12+ рыночных индикаторов: on-chain данные, сентимент и технические факторы.",
    ...
    compCol3: "TrendRider",
    compRow1: ["Контроль эмоций", "Сложно — страх и жадность", "Исключены — AI-алгоритм"],
